"""
Perform a program that generates a list of lists, emulating an array 
of order NxM, with N and M given by the user. Suppose this matrix is 
filled with the horizontal zig-zag shape according to the sequence 
...
# Fill the rows with the number of values as indicated by the variable
# column
counter = 1
